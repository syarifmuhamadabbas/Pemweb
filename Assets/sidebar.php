          ...
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="/PemWeb/views/index.php" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Pertemuan 2 dan 3</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="/PemWeb/views/pertemuan4.php" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Pertemuan 4</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="/PemWeb/views/pertemuan5.php" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Pertemuan 5</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="/PemWeb/views/pertemuan6.php" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Pertemuan 6</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="/PemWeb/views/pertemuan7.php" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Pertemuan 7</p>
                    </a>
                  </li>
